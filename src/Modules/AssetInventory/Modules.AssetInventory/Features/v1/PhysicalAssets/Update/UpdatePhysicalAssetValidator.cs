...
/// <summary>Validator for UpdatePhysicalAssetCommand.</summary>
public sealed class UpdatePhysicalAssetValidator : AbstractValidator<UpdatePhysicalAssetCommand>
{
    public UpdatePhysicalAssetValidator()
    {
        RuleFor(x => x.Id)
            .NotEmpty();
